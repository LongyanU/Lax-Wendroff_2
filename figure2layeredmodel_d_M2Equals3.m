...
% 时间已过 39.960201 秒。M=2
% 时间已过 42.931054 秒。M=3
clear
clc %%%%%%%
close all
...
% coeff2=[ 1.38491, -0.0968273];
% temp2= -2.57617;

coeff2=[ 1.56649, -0.178303, 0.0163449];
temp2= -2.80906;
tic
for it=1:nt-2,
...
%         +coeff1(7)*d2pz17;
%     
     d2px=coeff2(1)*d2px11+coeff2(2)*d2px12+coeff2(3)*d2px13;
    d2pz=coeff2(1)*d2pz11+coeff2(2)*d2pz12+coeff2(3)*d2pz13;
